...
def downloadimg(url, book):
    ...
    if 'img' in os.listdir(r'F:\jike\实践\111-main\pa'):
        pass
    else:
        os.mkdir(r'F:\jike\实践\111-main\pa\img')
    os.chdir(r'F:\jike\实践\111-main\pa\img')
    # 返回img的二进制流
...
if __name__ == '__main__':
    ...
    bookdata.to_csv('F:/jike/实践/111-main/pa/book.csv', index=False)
    print("图书信息写入本地成功")
